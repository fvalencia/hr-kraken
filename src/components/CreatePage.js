          ...
          return (
            <div className="pa4 flex justify-center bg-white">
              ...
              >
                ...
                />
                <Button flat primary swapTheming={!this.state.content || !this.state.title ? undefined : true} type="submit" disabled={!this.state.content || !this.state.title}>Create</Button>
